...
#ifndef FOXLEXER_ASCII
#define FOXLEXER_ASCII
...
namespace FoxLexer {
    ...
    namespace ASCII {
        ...
        namespace Detail {
            ...
            template <typename T>
            constexpr bool is_ascii_impl(std::true_type, T c) noexcept {
                return c >= 0;
            }

            template <typename T>
            constexpr bool is_ascii_impl(std::false_type, T c) noexcept {
                return c <= 0x7F;
            }
